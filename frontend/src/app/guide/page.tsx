...
const GARMIN_STEPS = [
  { n: 1, text: 'GPX 다운로드', img: '/guide/garmin-1.png' },
  { n: 2, text: 'Garmin Connect 앱 실행', img: '/guide/garmin-2.png' },
  { n: 3, text: '코스 메뉴에서 GPX 가져오기', img: '/guide/garmin-3.png' },
  { n: 4, text: '워치로 코스 전송', img: '/guide/garmin-4.png' },
  { n: 5, text: '워치에서 운동 시작', img: '/guide/garmin-5.png' },
]
